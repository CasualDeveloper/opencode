...
export const Definitions = {
  ...
  app_toggle_auto_approve_permissions: keybind("none", "Toggle auto-approve permissions"),
  ...
  usage_show: keybind("none", "Show usage limits"),
...
export const CommandMap = {
  ...
  app_toggle_auto_approve_permissions: "permission.mode",
