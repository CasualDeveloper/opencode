...
test("service filenames share release channels and identify preview channels", () => {
  ...
  expect(ServiceConfig.versionBelongsToChannel("0.0.0-casual-3b8949b1ee-1234.2", "casual")).toBe(true)
  expect(ServiceConfig.versionBelongsToChannel("0.0.0-casual-3b8949b1ee-1234", "preview-a")).toBe(false)
  expect(ServiceConfig.versionBelongsToChannel("0.0.0-casual-not-a-sha-1234", "casual")).toBe(false)
